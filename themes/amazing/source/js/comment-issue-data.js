...
var repoIssuesUrl = "https://api.github.com/repos/eatmeatball/blog_comment/issues";
...
function renderCommentData(COMMENT_ARR) {
    if (COMMENT_ARR.length > 0) {
        ...
        for (var i = 0; i < COMMENT_ARR.length; i++) {
            ...
            htmlContentWidget +=
                "<div class='card-comment-item'>" + "<a href=\"" + item.userUrl + "\"target=\"_blank\">" + "<img class='ava' src='" + item.userAvatar + "'  onerror='this.onerror = null;this.src=\"https://cdn.jsdelivr.net/npm/gitalk@1/src/assets/icon/github.svg\";'/></a>" +
...
function loadIssueData(appId, appKey, userName, userRepo, isValine) {
    ...
    setTimeout(function () { // 延迟1s执行，保证其余的先加载
        ...
        // console.clear();
        console.log("~~~~欢迎光临！记得有时间多来看看哦，https://eatmeatball.github.io/ ~~~~")
    }
        ,
        500
    )
